...
# Directory which will contain the IWP prediction polygon shapefiles clipped to the overlap-removed footprints
clipped_IWP_dir = "D:/manuscripts/Chandi_Anna_Nature/IWP_BanksWatershed_clipped"
